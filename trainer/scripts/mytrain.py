...
def main(cfg: TrainerConfig) -> None:
    ...
    # import datasets
    # datasets.config.DOWNLOADED_DATASETS_PATH = "/mnt/ssd1/ayano/.cache/huggingface/datasets/downloads"
    # datasets.config.HF_DATASETS_CACHE = "/mnt/ssd1/ayano/.cache/huggingface/datasets/"
